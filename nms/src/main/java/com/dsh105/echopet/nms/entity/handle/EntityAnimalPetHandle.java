...
public class EntityAnimalPetHandle extends EntityAgeablePetHandle implements IEntityAnimalPetHandle{
	
	public EntityAnimalPetHandle(IEntityAnimalPet entityPet){
		super(entityPet);
	}
}
