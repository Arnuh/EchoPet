...
public class EntityCatPet extends EntityTameablePet implements IEntityCatPet{
	...
	private static final EntityDataAccessor<CatVariant> DATA_VARIANT_ID = SynchedEntityData.defineId(EntityCatPet.class, EntityDataSerializers.CAT_VARIANT);
	...
	public void setType(CatType type){
		entityData.set(DATA_VARIANT_ID, Registry.CAT_VARIANT.get(new ResourceLocation(type.getNamespace())));
	}
