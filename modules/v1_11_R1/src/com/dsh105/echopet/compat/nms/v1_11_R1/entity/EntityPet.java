 ...
 */
package com.dsh105.echopet.compat.nms.v1_11_R1.entity;
...
import com.dsh105.echopet.compat.nms.v1_11_R1.NMSEntityUtil;
import com.dsh105.echopet.compat.nms.v1_11_R1.entity.ai.PetGoalFloat;
import com.dsh105.echopet.compat.nms.v1_11_R1.entity.ai.PetGoalFollowOwner;
import com.dsh105.echopet.compat.nms.v1_11_R1.entity.ai.PetGoalLookAtPlayer;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet{
	...
	*/
	...
	public void g(float sideMot, float forwMot){// Look at EntityHorseAbstract for shit
		...
		this.P = 1.0F;
		sideMot = ((EntityLiving) passenger).be * 0.5F;// 1 below lastDamage in EntityLiving
