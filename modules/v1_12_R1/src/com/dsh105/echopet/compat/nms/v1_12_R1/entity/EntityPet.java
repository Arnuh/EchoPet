...
import com.dsh105.echopet.compat.nms.v1_12_R1.NMSEntityUtil;
import com.dsh105.echopet.compat.nms.v1_12_R1.entity.ai.PetGoalFloat;
...
public abstract class EntityPet extends EntityCreature implements IAnimal, IEntityPet{
	...
	*/
	...
	public void a(float sideMot, float forwMot, float upMot){// ITS IN ENTITY LIVING
		...
		upMot = ((EntityLiving) passenger).bg;
		if(forwMot <= 0.0F){// ?
			forwMot *= 0.25F;
		}
		sideMot *= 0.75F;
