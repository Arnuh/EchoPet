...
public enum DataMenuItem{
	...
	BLUE(new HashSet<>(Arrays.asList(DataMenuType.COLOR, DataMenuType.PARROT_VARIANT)), PetData.BLUE, Material.WOOL, 1, (short) 11, "Blue", "Wool or Collar Color"),
	BROWN(DataMenuType.COLOR, PetData.BROWN, Material.WOOL, 1, (short) 12, "Brown", "Wool or Collar Color"),
	CYAN(new HashSet<>(Arrays.asList(DataMenuType.COLOR, DataMenuType.PARROT_VARIANT)), PetData.CYAN, Material.WOOL, 1, (short) 9, "Cyan", "Wool or Collar Color"),
	GRAY(new HashSet<>(Arrays.asList(DataMenuType.COLOR, DataMenuType.PARROT_VARIANT)), PetData.GRAY, Material.WOOL, 1, (short) 7, "Gray", "Wool or Collar Color"),
	GREEN(new HashSet<>(Arrays.asList(DataMenuType.COLOR, DataMenuType.PARROT_VARIANT)), PetData.GREEN, Material.WOOL, 1, (short) 13, "Green", "Wool or Collar Color"),
	LIGHT_BLUE(DataMenuType.COLOR, PetData.LIGHT_BLUE, Material.WOOL, 1, (short) 3, "Light Blue", "Wool or Collar Color"),
	...
	RED(new HashSet<>(Arrays.asList(DataMenuType.COLOR, DataMenuType.PARROT_VARIANT)), PetData.RED, Material.WOOL, 1, (short) 14, "Red", "Wool or Collar Color"),
    ...
    //
	BROWN_VARIANT(DataMenuType.LLAMA_VARIANT, PetData.BROWN_LLAMA, Material.WOOL, 1, (short) 12, "Brown", "Wool Color"),
	CREAMY_VARIANT(DataMenuType.LLAMA_VARIANT, PetData.CREAMY, Material.WOOL, 1, (short) 4, "Creamy", "Wool Color"),
	GRAY_VARIANT(DataMenuType.LLAMA_VARIANT, PetData.GRAY_LLAMA, Material.WOOL, 1, (short) 7, "Gray", "Wool Color"),
	WHITE_VARIANT(DataMenuType.LLAMA_VARIANT, PetData.WHITE_LLAMA, Material.WOOL, 1, (short) 0, "White", "Wool Color"),
	WHITE_LLAMA(DataMenuType.LLAMA_COLOR, PetData.WHITE, Material.CARPET, 1, (short) 0, "White", "Color"),
	ORANGE_LLAMA(DataMenuType.LLAMA_COLOR, PetData.ORANGE, Material.CARPET, 1, (short) 1, "Orange", "Color"),
	MAGENTA_LLAMA(DataMenuType.LLAMA_COLOR, PetData.MAGENTA, Material.CARPET, 1, (short) 2, "Magenta", "Color"),
	LIGHT_BLUE_LLAMA(DataMenuType.LLAMA_COLOR, PetData.LIGHT_BLUE, Material.CARPET, 1, (short) 3, "Light Blue", "Color"),
	YELLOW_LLAMA(DataMenuType.LLAMA_COLOR, PetData.YELLOW, Material.CARPET, 1, (short) 4, "Yellow", "Color"),
	LIME_LLAMA(DataMenuType.LLAMA_COLOR, PetData.LIME, Material.CARPET, 1, (short) 5, "Lime", "Color"),
	PINK_LLAMA(DataMenuType.LLAMA_COLOR, PetData.PINK, Material.CARPET, 1, (short) 6, "Pink", "Color"),
	GRAY_LLAMA(DataMenuType.LLAMA_COLOR, PetData.GRAY, Material.CARPET, 1, (short) 7, "Gray", "Color"),
	SILVER_LLAMA(DataMenuType.LLAMA_COLOR, PetData.SILVER, Material.CARPET, 1, (short) 8, "Silver", "Color"),
	CYAN_LLAMA(DataMenuType.LLAMA_COLOR, PetData.CYAN, Material.CARPET, 1, (short) 9, "Cyan", "Color"),
	PURPLE_LLAMA(DataMenuType.LLAMA_COLOR, PetData.PURPLE, Material.CARPET, 1, (short) 10, "Purple", "Color"),
	BLUE_LLAMA(DataMenuType.LLAMA_COLOR, PetData.BLUE, Material.CARPET, 1, (short) 11, "Blue", "Color"),
	BROWN_LLAMA(DataMenuType.LLAMA_COLOR, PetData.BROWN, Material.CARPET, 1, (short) 12, "Brown", "Color"),
	GREEN_LLAMA(DataMenuType.LLAMA_COLOR, PetData.GREEN, Material.CARPET, 1, (short) 13, "Green", "Color"),
	RED_LLAMA(DataMenuType.LLAMA_COLOR, PetData.RED, Material.CARPET, 1, (short) 14, "Red", "Color"),
	BLACK_LLAMA(DataMenuType.LLAMA_COLOR, PetData.BLACK, Material.CARPET, 1, (short) 15, "Black", "Color"),
