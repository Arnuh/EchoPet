...
import com.dsh105.echopet.compat.api.util.ReflectionUtils.PackageType;
...
public enum ParticleEffect{
	...
	public static final class ParticlePacket{
		...
		public static void initialize() throws VersionIncompatibleException{
			...
			try{
				Integer oneten = ObjectParser.isInt(Character.toString(PackageType.getServerVersion().charAt(4)));
				version = Integer.parseInt(Character.toString(PackageType.getServerVersion().charAt(3)));
				version = Integer.parseInt(PackageType.getServerVersion().split("_")[1]);
				if(oneten != null){
					version = ObjectParser.isInt(version + "" + oneten);
				}
				if(version > 7){
