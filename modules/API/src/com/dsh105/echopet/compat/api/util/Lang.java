...
public enum Lang{
	...
	INVALID_PET_DATA_VALUE("invalid_pet_data_value", "&6%value% &efor &6%data% &eis an invalid data value."),
	INVALID_PET_DATA_TYPE_FOR_PET("invalid_pet_data_type_for_pet", "&6%data% &eis invalid for the &6%type% &epet type."),
	...
	PET_PRE_SPAWN_CANCELLED("pet_pre_spawn_cancelled", "&ePet spawn was cancelled externally."),
