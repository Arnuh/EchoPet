...
public class EntityWardenPetHandle extends LivingEntityPetHandle implements IEntityWardenPetHandle{
	
	public EntityWardenPetHandle(IEntityLivingPet entityPet){
		super(entityPet);
	}
	
	public EntityWardenPet get(){
		return (EntityWardenPet) getEntity();
	}
