 ...
 */
package com.dsh105.echopet.compat.nms.v1_14_R1.entity.ai;
...
public class PetGoalLookAtPlayer extends APetGoalLookAtPlayer{
	...
	@Override
	public void tick(){
		this.pet.getControllerLook().a(this.player.locX, this.player.locY + this.player.getHeadHeight(), this.player.locZ);
		--this.ticksLeft;
	}
}
