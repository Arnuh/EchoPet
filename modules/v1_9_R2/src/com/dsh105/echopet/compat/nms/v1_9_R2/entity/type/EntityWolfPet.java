...
import com.dsh105.echopet.compat.nms.v1_9_R2.entity.EntityTameablePet;
    ...
    public void onLive() {
        ...
        if (this.inWater) {
            ...
            if (this.shakeCount == 0.0F) {
				// After sounds
				makeSound("entity.wolf.shake", ce(), (this.random.nextFloat() - this.random.nextFloat()) * 0.2F + 1.0F);
            }
