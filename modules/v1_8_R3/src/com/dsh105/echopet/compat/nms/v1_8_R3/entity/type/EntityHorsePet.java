...
public class EntityHorsePet extends EntityAgeablePet implements IEntityHorseAbstractPet, IEntityHorsePet, IEntityHorseChestedAbstractPet{
    ...
    @Override
	public void setVariant(HorseVariant t){
		if(t != HorseVariant.HORSE){
            this.setArmour(HorseArmour.NONE);
        }
		this.datawatcher.watch(19, Byte.valueOf((byte) t.ordinal()));
    }
	...
	public void setColor(Horse.Color color){
		datawatcher.watch(20, (color.ordinal() & 0xFF | getStyle().ordinal() << 8));
	}
    ...
    public void setArmour(HorseArmour a) {
		if(this.datawatcher.getByte(19) == Byte.valueOf((byte) HorseVariant.HORSE.ordinal())){
    ...
    @Override
	protected void makeStepSound(BlockPosition position, Block block){
        Block.StepSound stepsound = block.stepSound;

		if(this.world.getType(position) == Blocks.SNOW){
