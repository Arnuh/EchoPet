...
public interface IEntityArmadilloPetHandle extends IEntityAnimalPetHandle{
	
	void switchToState(IArmadilloPet.ArmadilloState state);
	
	IArmadilloPet.ArmadilloState getState();
}
